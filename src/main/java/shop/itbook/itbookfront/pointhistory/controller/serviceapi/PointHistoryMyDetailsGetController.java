...
public class PointHistoryMyDetailsGetController {
    ...
    public String orderDetails(@PathVariable Long pointHistoryNo, @AuthenticationPrincipal UserDetailsDto userDetailsDto) {
    ...
    public String gradeDetails(@PathVariable Long pointHistoryNo, Model model, HttpSession session, @AuthenticationPrincipal UserDetailsDto userDetailsDto) {
    ...
    public String couponDetails(@PathVariable Long pointHistoryNo, Model model, HttpSession session, @AuthenticationPrincipal UserDetailsDto userDetailsDto) {
    ...
    public String reviewDetails(@PathVariable Long pointHistoryNo, Model model, @AuthenticationPrincipal UserDetailsDto userDetailsDto) {
